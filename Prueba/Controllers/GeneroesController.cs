...
namespace Prueba.Controllers
{
    ...
    public class GeneroesController : Controller
    {
        ...
        public GeneroesController(LBooks20Context context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Index()
        {
              return _context.Generos != null ? 
                          ...
                          Problem("Entity set 'LBooks20Context.Generos'  is null.");
        }
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'LBooks20Context.Generos'  is null.");
            }
            var genero = await _context.Generos.FindAsync(id);
            if (genero != null)
            {
