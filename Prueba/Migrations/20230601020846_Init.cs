    ...
    public partial class Init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "ID AUTOR");
                    table.ForeignKey(
                        name: "FK_LIBRO_GENERO",
                        column: x => x.IDGENERO,
                        principalTable: "GENERO",
                        principalColumn: "ID GENERO");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_RESEÑAS", x => x.IDRESEÑAS);
                    table.ForeignKey(
                        name: "FK_RESEÑAS_LIBRO",
                        column: x => x.IDLIBRO,
                        principalTable: "LIBRO",
                        principalColumn: "ID LIBRO");
                    table.ForeignKey(
                        name: "FK_RESEÑAS_USUARIO",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LIBRO_ID AUTOR",
                table: "LIBRO",
                column: "ID AUTOR");

            migrationBuilder.CreateIndex(
                name: "IX_LIBRO_ID GENERO",
                table: "LIBRO",
                column: "ID GENERO");

            migrationBuilder.CreateIndex(
                name: "IX_RESEÑAS_ID  LIBRO",
                table: "RESEÑAS",
                column: "ID  LIBRO");

            migrationBuilder.CreateIndex(
                name: "IX_RESEÑAS_ID USUARIO",
                table: "RESEÑAS",
                column: "ID USUARIO");
        }
